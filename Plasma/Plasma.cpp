...
void fn_vDemoScene_Plasma_Render(SDL_Window* window)
{
...
//    game_screen_height = screen_height * SCREEN_HEIGHT_PERCENT / 100;
    ...
    // Create the window
    SDL_Window* window = SDL_CreateWindow("Plasma", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, game_screen_width, game_screen_height, SDL_WINDOW_SHOWN | SDL_WINDOW_RESIZABLE);
    if (window == NULL)
    {
    ...
    while (running)
    {
        ...
        // plasma effect
        fn_vDemoScene_Plasma_Render(window);
